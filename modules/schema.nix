{lib, ...}: let
  ...
  configuration = types.submodule {
    options = {
      ...
      features = mkOption {
        type = types.listOf name;
        default = [];
      };
      extraModules = mkOption {
        type = types.listOf module;
        default = [];
      };
    };
  };
...
in {
  options.retr0astic = mkOption {
    type = types.submodule ({...}: {
      options = {
        hosts = mkOption {
          type = types.lazyAttrsOf host;
          default = {};
        };
        configurations = mkOption {
          type = types.lazyAttrsOf configuration;
          default = {};
        };
        configurationAliases = mkOption {
          type = types.lazyAttrsOf types.str;
          default = {};
        };
        features = mkOption {
          type = types.lazyAttrsOf feature;
          default = {};
        };
        desktops = mkOption {
          type = types.lazyAttrsOf desktop;
          default = {};
        };
        shells = mkOption {
          type = types.lazyAttrsOf shell;
          default = {};
        };
        themes = mkOption {
          type = types.lazyAttrsOf theme;
          default = {};
        };
        users = mkOption {
          type = types.lazyAttrsOf user;
          default = {};
        };
        integrations = mkOption {
          type = types.lazyAttrsOf integration;
          default = {};
        };
        validation.resolve = mkOption {
          type = types.raw;
          readOnly = true;
        };
        validation.validatePair = mkOption {
          type = types.raw;
          readOnly = true;
        };
        validation.rejectDuplicates = mkOption {
          type = types.raw;
          readOnly = true;
        };
        validation.composeUserHomes = mkOption {
          type = types.raw;
          readOnly = true;
        };
